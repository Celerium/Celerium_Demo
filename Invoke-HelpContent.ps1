...
if ( [bool](Get-Command -Name Update-HelpContent -ErrorAction SilentlyContinue) ){
    ...
    $parameters = @{
        moduleName      = 'SentinelOneAPI'
        helpDocsPath    = "C:\Celerium\Projects\urban-fortnight\docs"
        csvFilePath     = "C:\Celerium\Projects\urban-fortnight\docs\S1-Endpoints-v2.1.csv"
        githubPageUri   = "https://celerium.github.io/urban-fortnight"
        verbose         = $true
    }
