...
online version: https://celerium.github.io/urban-fortnight/site/NetworkQuarantineControl/Get-S1FirewallCategoryRules.html
parent: GET
schema: 2.0.0
title: Get-S1FirewallCategoryRules
---

# Get-S1FirewallCategoryRules
...
```powershell
Get-S1FirewallCategoryRules -firewall_rule_category <String> [-accountIds <Int64[]>] [-actions <String[]>]
