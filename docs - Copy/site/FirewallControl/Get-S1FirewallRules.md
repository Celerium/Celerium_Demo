...
online version: https://celerium.github.io/urban-fortnight/site/FirewallControl/Get-S1FirewallRules.html
parent: GET
schema: 2.0.0
title: Get-S1FirewallRules
---
...
```powershell
Get-S1FirewallRules [-accountIds <String[]>] [-actions <String[]>] [-application__contains <String[]>]
