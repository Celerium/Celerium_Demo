...
online version: https://celerium.github.io/urban-fortnight/site/ExclusionsAndBlacklist/Get-S1Exclusions.html
parent: GET
schema: 2.0.0
title: Get-S1Exclusions
---
...
```powershell
Get-S1Exclusions [-accountIds <String[]>] [-countOnly] [-createdAt__between <String>]
