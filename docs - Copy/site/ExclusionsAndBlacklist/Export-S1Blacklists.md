...
online version: https://celerium.github.io/urban-fortnight/site/ExclusionsAndBlacklist/Export-S1Blacklists.html
parent: GET
schema: 2.0.0
title: Export-S1Blacklists
---
...
```powershell
Export-S1Blacklists [-accountIds <String[]>] [-createdAt__between <String>] [-createdAt__gt <DateTime>]
