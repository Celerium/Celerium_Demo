...
online version: https://celerium.github.io/urban-fortnight/site/Threats/Get-S1ThreatTimelines.html
parent: GET
schema: 2.0.0
title: Get-S1ThreatTimelines
---

# Get-S1ThreatTimelines
...
```powershell
Get-S1ThreatTimelines -threat_id <String> [-accountIds <Int64[]>] [-activityTypes <Int64[]>] [-countOnly]
