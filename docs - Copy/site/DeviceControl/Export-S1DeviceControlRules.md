...
online version: https://celerium.github.io/urban-fortnight/site/DeviceControl/Export-S1DeviceControlRules.html
parent: GET
schema: 2.0.0
title: Export-S1DeviceControlRules
---
...
```powershell
Export-S1DeviceControlRules [-accessPermissions <String[]>] [-accountIds <String[]>] [-actions <String[]>]
