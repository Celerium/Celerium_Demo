...
online version: https://celerium.github.io/urban-fortnight/site/ThreatIntelligence/Get-S1ThreatIntelligence.html
parent: GET
schema: 2.0.0
title: Get-S1ThreatIntelligence
---
...
```powershell
Get-S1ThreatIntelligence [-accountIds <Int64[]>] [-batchId <String>] [-category__in <String>] [-countOnly]
