...
$Test_Results = Invoke-Pester -Path .\Tests\Private\APIKey.Tests.ps1 `
                    -CodeCoverage .\RocketCyberAPI\Private\APIKey.ps1 `
...
$pester_Options = @{
    ...
    CodeCoverage = @{
        Enabled = $true
        Path = ".\RocketCyberAPI\Private\APIKey.ps1"
...
#$Test_Results = Invoke-Pester -Path .\Tests\Private\APIKey.Tests.ps1 - .\RocketCyberAPI\Private\APIKey.ps1 -PassThru
